    ...
    <div className="max-w-4xl mx-auto space-y-10">
      <section className="bg-slate-800/40 rounded-3xl p-8 shadow-sm border border-slate-700/50 flex flex-col md:flex-row gap-8 items-start md:items-center">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">구글 크롬 오프라인 설치파일</h1>
          <p className="text-lg text-slate-300 mb-4">개발사: Google | 카테고리: 웹 브라우저 | 라이선스: 무료</p>
      ...
      <section className="bg-slate-800/60 rounded-3xl p-8 text-center border border-slate-700/50">
        <h2 className="text-2xl font-bold text-white mb-4">인터넷 없이 USB로 바로 설치하는 진짜 설치파일</h2>
        <p className="text-slate-300 mb-8">다운로드 중 멈춤 현상(무한 로딩)이 발생한다면 인터넷 연결이 필요 없는 100MB 크기의 오프라인 풀버전 패키지를 받으세요.</p>
      ...
      <section className="bg-slate-800/40 rounded-3xl p-8 shadow-sm border border-slate-700/50 prose prose-blue max-w-none">
        <h2 className="text-2xl font-bold text-white mb-4 mt-0">일반 다운로드와 오프라인 버전의 차이점</h2>
