    ...
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row gap-8 items-start md:items-center">
        ...
        <div className="flex-1">
          ...
          <p className="text-lg text-gray-600 mb-4">개발사: 한글과컴퓨터 | 카테고리: 오피스/문서 | 라이선스: 무료</p>
      ...
      <section className="bg-blue-50 rounded-3xl p-8 text-center border border-blue-100">
        ...
        <p className="text-gray-600 mb-8">문서를 수정할 필요 없이 읽고 인쇄만 하실 거라면, 무거운 정품 대신 가볍고 무료인 한컴오피스 공식 뷰어를 사용하세요.</p>
      ...
      <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 prose prose-blue max-w-none">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">최근 정부 기관과 관공서에서 기본 문서 형식을 <code>HWP</code>에서 개방형인 <code>HWPX</code>로 완전히 변경했습니다. 예전 구버전 한글 프로그램에서는 이 HWPX 파일이 열리지 않아 당황하시는 분들이 많습니다.</p>
